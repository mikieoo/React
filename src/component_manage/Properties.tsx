...
// - 자식 컴포넌트에서는 함수의 매개변수 방식으로 속성값을 받음
// - 전달할 수 있는 데이터는 변수에 담믈 수 있는 모든 데이터 형태
// - 컴포넌트가 리렌더링되는 기준
...
function Child({ sequence, title, subTitle, contents, child }: Props) { // 매개변수로 받아올 때부터 구조화 파괴를 함
...
export default function Properties() {
    ...
    return (
        <div>
            <Child sequence={article.sequence} title='엔비디아 맹추격' subTitle='최경미 기자' contents='행보로 풀이된다.' />
